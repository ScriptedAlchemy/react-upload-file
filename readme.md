...
The previous author stopped and archived this, I tried to get a response for a repo transfer but nothing came of it. Ill be maintaing it from now on

### Why 
Its the best and most simple file uploader ive found.
I dont want it to die because im sick of these *bullshit* file uploaders.
Why does a file uploader need to have so much bloat and be so cumbersome?

Simple - Sweet - Sexy - Maintained by a reputable developer too :D
